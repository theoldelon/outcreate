...
<body class="bg-gray-300 text-gray-800">
    <!-- Navbar -->
    <nav class="bg-gray-900 dark:bg-gray-900 text-light py-4 px-6 fixed top-0 left-0 right-0 z-50 shadow-lg bg-opacity-75">
            ...
            <div class="hidden md:flex items-center space-x-4 font-semibold">
                @auth
                    <div x-data="{ open: false }" class="relative">
                        ...
                        <div x-show="open" @click.away="open = false" class="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-2 z-50">
                            <a href="{{ url('/profile') }}" class="block px-4 py-2 text-gray-700 hover:bg-gray-200">
                                <i class="fa-solid fa-circle-user"></i> View Profile
                            </a>
                            <a href="{{ url('/dashboard') }}" class="block px-4 py-2 text-gray-700 hover:bg-gray-200">
                                <i class="fas fa-tachometer-alt mr-2"></i> Dashboard
                            </a>
                            <a href="#" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="block px-4 py-2 text-gray-700 hover:bg-gray-200">
                ...
                @else
                    <div x-data="{ open: false }" class="relative">
                        ...
                        <div x-show="open" @click.away="open = false" class="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-2 z-50">
                            <a href="{{ url('/login') }}" class="block px-4 py-2 text-gray-700 hover:bg-gray-200">
                                <i class="fas fa-sign-in-alt mr-2"></i> Log in
                            </a>
                            <a href="{{ url('/register') }}" class="block px-4 py-2 text-gray-700 hover:bg-gray-200">
