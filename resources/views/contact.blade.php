...
<!-- Make sure you get your own form id at fabform.io for this to save the form submissions. -->

<body class="bg-gray-800 text-gray-100 px-8 py-12">
  <form action="https://fabform.io/f/xxxxx" method="post" class="mb-24 my-12">

      <div class="text-center w-full ">

        <!-- Place the SVG-converted Logo Here -->
        ...
        <div class="flex flex-col justify-between">
          <div>
            ...
            <div class="text-gray-700 mt-8">
              Hate forms? Send us an email instead <span class="underline"><a target="_BLANK" href="https://veilmail.io/irish-irish-geoff">https://veilmail.io/irish-geoff</a></span>
            </div>
          </div>
